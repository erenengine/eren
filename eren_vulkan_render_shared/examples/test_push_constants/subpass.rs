...
use super::{camera::CameraUBO, model::PushModel, vertex::Vertex};
...
impl TestSubpass {
    pub fn new(
        ...
        let buffer_size = std::mem::size_of::<CameraUBO>() as vk::DeviceSize;
    ...
    fn update_uniform_buffer(
        ...
        unsafe {
            ...
            std::ptr::copy_nonoverlapping(&ubo, data_ptr as *mut CameraUBO, 1);
        }
    }
